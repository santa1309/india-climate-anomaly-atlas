"""
Bihar district-wise weekly rainfall departure — maps + CSV, June-September 2026.
...
STATE = "BIHAR"
# Every week JSON the generator has published for these months — the newest
# month is partial (September: W1 so far), so glob rather than assume 4 weeks.
